...
CREATE TABLE "incoming_loads" (
	...
	"carrier" varchar(100),
	"notes" text,
	"load_cost" numeric(10, 2) NOT NULL,
	"freight_cost" numeric(10, 2) NOT NULL,
	"freight_cost_currency" varchar(3) DEFAULT 'CAD' NOT NULL,
	"profit_roi" numeric(10, 2) NOT NULL,
	"bol_file" text,
...
CREATE TABLE "invoices" (
	...
	"freight_cost_currency" varchar(3) DEFAULT 'USD' NOT NULL,
